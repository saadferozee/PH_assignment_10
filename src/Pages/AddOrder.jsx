...
const AddOrder = () => {
    ...
    const handleAddOrder = e => {
        ...
        axios.post(`http://localhost:3568/orders`, orderData)
            .then(response => {
                        ...
                        <form onSubmit={handleAddOrder} className='w-full px-2'>
                            <fieldset className="fieldset w-full bg-[#556B2F] border-none shadow-2xl shadow-[#00000070] rounded-3xl border p-6 sm:p-10">
                                ...
                                <div className='flex justify-between'>
                                    ...
                                    <input type="text" name='buyerName' className="w-[80%] input px-6 rounded-full" defaultValue={user?.displayName} readOnly />
                                </div>

                                <div className='flex justify-between'>
                                    <label className="label text-[#F7F3E9]">{isPet ? "Adopter's Name :" :'Buyer Email :'}</label>
                                    <input type="text" name='buyerEmail' className="input px-6 w-[80%] rounded-full" defaultValue={user?.email} readOnly />
                                </div>

                                <div className='flex justify-between'>
                                    <label className="label text-[#F7F3E9]">{isPet ? 'Pet Id :' : 'Product Id :'}</label>
                                    <input type="text" name='productId' className="input px-6 w-[80%] rounded-full" defaultValue={product?._id} disabled />
                                </div>

                                <div className='flex justify-between'>
                                    <label className="label text-[#F7F3E9]">Product Name :</label>
                                    <input type="text" name='productName' className="input px-6 w-[80%] rounded-full" defaultValue={product?.name} readOnly />
                                </div>
                                ...
                                <div className='flex justify-between'>
                                    ...
                                    <input type="text" name='location' className="input px-6 w-[80%] rounded-full" defaultValue={product?.location} readOnly />
                                </div>

                                <div className='flex justify-between'>
                                    <label className="label text-[#F7F3E9]">Date (pickup) :</label>
                                    <input type="date" name='date' className="input px-6 w-[80%] rounded-full" placeholder="Date (Pick Up)" required />
                                </div>
                                ...
                                <div className='flex justify-between'>
                                    ...
                                    <textarea type="text" name='note' className="textarea h-fit px-6 w-[80%] rounded-3xl" placeholder='Write Additional Note' />
                                </div>
